...
window.tutorials = [
        ...
        steps: [
            {
                ...
                subSteps: [
                    ...
                    },
                    {
                        ...
                        message:
                            '「もっと詳しい説明はこちら」のリンクをクリックして、APIキー取得方法を読んでください。',
                    ...
                    },
                    {
                        // step3: 閉じるボタンを押させる
                        message:
                            'よく読み、APIキー（sk-から始まる文字列）を取得してください。取得できましたら、説明画面の「閉じる」を押してください。',
    ...
    },
    {
        ...
        title: 'ガチャの流れ',
        description:
            'トップ画面 から ガチャ画面 へ進み、ガチャを引いて倉庫で確認するまでの流れを解説します。',
        ...
        steps: [
            ...
            // 3) 再び index.html に戻って倉庫へ
            {
                ...
                subSteps: [
                    ...
                    {
                        message:
                            '倉庫の説明は後ほどするとして、ガチャしたカードが表示されていると思います。',
                    },
                    {
        ...
        steps: [
            {
                ...
                subSteps: [
                    ...
                    },
                    {
                        // 2) 左側タブの紹介
                        message:
                            '画面上のタブをクリックすると、種類ごとにカードを絞り込めます。試しに切り替えてみましょう。',
                    ...
                    },
                    {
                        // 7) 選択モードの使い方
                        message:
                            '複数のカードを一括操作したい場合は「選択モード」を使いましょう。選択モードをオンにするとカードを複数同時選択ができます。まとめて削除できます。',
                        highlightSelector: '#toggle-warehouse-selection-mode-btn',
                    },
                    {
                        // 2) 左側タブの紹介
                        message:
                            'カードをクリックすると、赤い枠が付きます。左上の選択したカードを削除ボタンを押すことで、削除が可能になります。',
                    },
                    {
                        // 8) 倉庫を閉じる
                        message:
        ...
        steps: [
            ...
            // ---------- scenario.html ----------
            {
                ...
                subSteps: [
                    ...
                    {
                        message:
                            'これでシナリオの作成は完了です。左上のホームボタンからトップページに戻れます。',
                        highlightSelector: '#back-to-menu',
                    },
                    {
                        message:
